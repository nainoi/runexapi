...
const UPLOAD_KAO = "/upload/image/kao/"
const HTTP = "http://"
const HTTPS = "https://"
...
const (
	...
	REGISTER_WAIT_CONFIRM   string = "WAIT_CONFIRM"
	...
	ACTIVITY_STATUS_APPROVE string = "APPROVE"
	ACTIVITY_STATUS_REJECT  string = "REJECT"
	ACTIVITY_STATUS_WAITING string = "WAITING"
)
