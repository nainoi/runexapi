...
type StravaActivity struct {
	...
	TotalElevationGain         float64           `json:"total_elevation_gain" bson:"total_elevation_gain"`
	...
	ElevHigh                   float64           `json:"elev_high" bson:"elev_high"`
	ElevLow                    float64           `json:"elev_low" bson:"elev_low"`
...
type SplitsMetric struct {
	Distance                  float64 `json:"distance" bson:"distance"`
	ElapsedTime               int     `json:"elapsed_time" bson:"elapsed_time"`
	ElevationDifference       float64 `json:"elevation_difference" bson:"elevation_difference"`
	MovingTime                int     `json:"moving_time" bson:"moving_time"`
	Split                     int     `json:"split" bson:"split"`
	AverageSpeed              float64 `json:"average_speed" bson:"average_speed"`
	AverageGradeAdjustedSpeed float64 `json:"average_grade_adjusted_speed" bson:"average_grade_adjusted_speed"`
...
type SimilarActivities struct {
	...
	AverageSpeed       float64 `json:"average_speed" bson:"average_speed"`
	MinAverageSpeed    float64 `json:"min_average_speed" bson:"min_average_speed"`
	MidAverageSpeed    float64 `json:"mid_average_speed" bson:"mid_average_speed"`
	MaxAverageSpeed    float64 `json:"max_average_speed" bson:"max_average_speed"`
...
type Trend struct {
	Speeds               []float64 `json:"speeds" bson:"speeds"`
	CurrentActivityIndex int       `json:"current_activity_index" bson:"current_activity_index"`
	MinSpeed             float64   `json:"min_speed" bson:"min_speed"`
	MidSpeed             float64   `json:"mid_speed" bson:"mid_speed"`
	MaxSpeed             float64   `json:"max_speed" bson:"max_speed"`
...
type Lab struct {
	...
	AverageSpeed       float64   `json:"average_speed" bson:"average_speed"`
	MaxSpeed           float64   `json:"max_speed" bson:"max_speed"`
	LapIndex           int       `json:"lap_index" bson:"lap_index"`
	Split              int       `json:"split" bson:"split"`
	PaceZone           int       `json:"pace_zone" bson:"pace_zone"`
}
