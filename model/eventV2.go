...
// EventResponse from event managment
...
type Shirts struct {
	...
	ShortSleeveShirt bool   `json:"short_sleeve_shirt" bson:"short_sleeve_shirt"`
	Size             string `json:"size" bson:"size"`
	SleevelessShirt  bool   `json:"sleeveless_shirt" bson:"sleeveless_shirt"`
}
